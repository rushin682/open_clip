...
if __name__ == "__main__":
    ...
    preprocess_fn = transforms.Compose([transforms.Resize((224, 224), interpolation=Image.BICUBIC),
                                               transforms.ToTensor()])
    ...
    dataset = H5Dataset('HTAN-WUSTL.csv', transforms=preprocess_fn, tokenizer=tokenizer)
